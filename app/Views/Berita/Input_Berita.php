    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>Tambah Berita</h3>
                <p class="text-subtitle text-muted">Form untuk menambahkan berita baru.</p>
            </div>
                    ...
                    <div class="col-md-8">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="judul" name="judul"
                                value="<?= old('judul') ?>" onkeyup="generateSlug()" required>
                        </div>
                        <div class="mb-3">
                            <label for="slug" class="form-label">Slug URL</label>
                            <input type="text" class="form-control" id="slug" name="slug"
                                value="<?= old('slug') ?>">
                            <small class="text-muted">URL: <span id="slugPreview"><?= old('slug') ?></span></small>
                        </div>
                        <div class="col-md-6">
