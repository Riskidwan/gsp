  ...
  <section class="hero" style="background: #1976d2; color: #fff; min-height: 100vh; display: flex; align-items: center; padding: 0;">
    <div style="max-width:1200px; margin:auto; display:flex; flex-wrap:wrap; align-items:center; gap:32px; padding:56px 24px;">
      <div style="flex:1 1 420px; min-width:280px; z-index:2;">
        ...
        <p style="font-size:1.35rem; color:#bbdefb; margin-bottom:1.2rem;">Pelatihan Operator Perakitan Kabel Kendaraan</p>
  ...
  <section class="section" style="background:#f3f8ff;">
    <div class="container" style="display:flex; flex-wrap:wrap; gap:32px; align-items:center;">
      <div style="flex:1 1 340px; min-width:260px;">
        <h2 style="color:#1565c0;">Tentang Pelatihan Wiring Harness</h2>
        <p style="font-size:1.08rem; color:#444;">
          Wiring harness adalah rangkaian kabel yang dirakit dan diikat menjadi satu kesatuan, berfungsi untuk menghantarkan arus listrik dan sinyal dalam sistem kendaraan. Peserta akan dilatih dalam pembuatan, perakitan, serta pengujian kualitas wiring harness sesuai standar pabrik.
        </p>
        <ul style="font-size:1rem; color:#444; margin-top:1rem; padding-left:18px;">
          <li>Pengelompokan kabel dan terminal</li>
        <li>Pemasangan connector dan socket</li>
        <li>Pengujian continuity dan kelistrikan</li>
        <li>Pengemasan sesuai standar otomotif</li>
        </ul>
      </div>
...
<!-- SLIDE: Kegiatan & Hasil Pelatihan -->
<section id="projects" class="section">
  <div class="container">
    <h2 class="section-title">Kegiatan & Hasil Pelatihan Wiring Harness</h2>
    <p class="section-subtitle">
      Berikut adalah dokumentasi kegiatan pelatihan dan hasil praktik pembuatan wiring harness oleh peserta pelatihan LPK kami.
    </p>
  ...
  <section class="section" style="background:#fff; padding:60px 20px;">
    <div class="container" style="max-width:600px; margin:auto;">
      ...
      <p style="text-align:center; font-size:1.1rem; color:#555; margin-bottom:30px;">
        Kami mengharapkan ulasan dari Anda tentang kualitas Pemagangan Wiring Harness
      </p>
  ...
  <!-- SLIDE: Testimoni Pemagang Wiring Harness -->
<section class="section" style="background:#f3f8ff; padding:100px 0;">
  <div class="container" style="max-width:1200px; margin:auto; padding:0 24px;">
    <h2 style="color:#1565c0; text-align:center; font-size:2.8rem; margin-bottom:3rem;">
      Testimoni Pemagang Wiring Harness
    </h2>
      ...
      <div style="background:#ffffff; border-radius:20px; padding:40px; box-shadow:0 10px 25px rgba(0,0,0,0.08);">
        <div style="display:flex; align-items:center; margin-bottom:1.5rem;">
          ...
          <div>
            ...
            <p style="color:#666; margin:0; font-size:0.9rem;">Magang di PT XYZ Wiring Systems</p>
          </div>
        </div>
        <p style="font-size:1.1rem; color:#444; font-style:italic;">
          "Selama magang, saya belajar proses perakitan kabel dari awal sampai QC. Pengalaman ini membuka wawasan saya tentang pentingnya presisi dan ketelitian."
        </p>
      ...
      <div style="background:#ffffff; border-radius:20px; padding:40px; box-shadow:0 10px 25px rgba(0,0,0,0.08);">
        <div style="display:flex; align-items:center; margin-bottom:1.5rem;">
          ...
          <div>
            ...
            <p style="color:#666; margin:0; font-size:0.9rem;">Magang di PT ABC Harness Manufacturing</p>
          </div>
        </div>
        <p style="font-size:1.1rem; color:#444; font-style:italic;">
          "Instruktur di perusahaan sangat sabar membimbing. Saya jadi paham cara membaca diagram wiring dan menggunakan alat crimping dengan benar."
        </p>
        <div style="color:#ffd700; font-size:1.2rem; margin-top:1rem;">⭐⭐⭐⭐⭐</div>
      </div>
      ...
      <div style="background:#ffffff; border-radius:20px; padding:40px; box-shadow:0 10px 25px rgba(0,0,0,0.08);">
        <div style="display:flex; align-items:center; margin-bottom:1.5rem;">
          ...
          <div>
            ...
            <p style="color:#666; margin:0; font-size:0.9rem;">Magang di PT Kabelindo</p>
          </div>
        </div>
        <p style="font-size:1.1rem; color:#444; font-style:italic;">
          "Magang ini memberi saya kesempatan untuk bekerja langsung di lini produksi dan memahami standar keamanan dalam pembuatan wiring harness."
        </p>
        <div style="color:#ffd700; font-size:1.2rem; margin-top:1rem;">⭐⭐⭐⭐⭐</div>
      </div>
