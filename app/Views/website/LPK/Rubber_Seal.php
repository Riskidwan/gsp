...
<section class="section" style="background:#f3f8ff;">
  ...
  <section id="projects" class="section">
    <div class="container">
      <h2 class="section-title">Kegiatan & Hasil Pelatihan Rubber Seal</h2>
      <p class="section-subtitle">
        Dokumentasi kegiatan pelatihan dan hasil praktik pembuatan rubber seal oleh peserta LPK kami.
      </p>
  ...
  <section class="section" style="background:#fff; padding:60px 20px;">
    <div class="container" style="max-width:600px; margin:auto;">
      ...
      <p style="text-align:center; font-size:1.1rem; color:#555; margin-bottom:30px;">
        Kami mengharapkan ulasan dari Anda tentang kualitas Pemagangan Rubber Seal
      </p>
