...
<head>
  ...
  <title>Packing - PT Gemilang Sapta Perdana</title>
...
<body>
  ...
  <section class="hero" style="background: linear-gradient(135deg, #02a85a 0%, #02a85a 100%); color: #fff; min-height: 100vh; display: flex; align-items: center; padding: 0;">
    <div style="max-width:1200px; margin:auto; display:flex; flex-wrap:wrap; align-items:center; gap:32px; padding:56px 24px;">
      <div style="flex:1 1 420px; min-width:280px; z-index:2;">
        ...
        <p style="font-size:1.35rem; color:#bbdefb; margin-bottom:1.2rem;">Pelatihan Operator Pengemasan Produk</p>
        <p style="font-size:1.13rem; color:#e3f2fd; margin-bottom:1.5rem; max-width:500px;">
            Program pelatihan Packing membekali peserta dengan keterampilan menyiapkan, mengemas, dan memastikan produk siap kirim sesuai standar mutu dan keamanan.
        </p>
  ...
  <section class="section" style="background:#f3f8ff;">
    <div class="container" style="display:flex; flex-wrap:wrap; gap:32px; align-items:center;">
      <div style="flex:1 1 340px; min-width:260px;">
        <h2 style="color:#1565c0;">Tentang Pelatihan Packing</h2>
        <p style="font-size:1.08rem; color:#444;">
          Pelatihan ini fokus pada prosedur pengemasan yang efektif, aman, dan sesuai spesifikasi produk. Peserta mempelajari teknik pengemasan manual maupun menggunakan mesin.
        </p>
        <ul style="font-size:1rem; color:#444; margin-top:1rem; padding-left:18px;">
          <li>Persiapan produk sebelum dikemas</li>
          <li>Teknik pengemasan manual & mesin</li>
          <li>Labeling dan identifikasi produk</li>
          <li>Standar keamanan dan kebersihan pengemasan</li>
        </ul>
      </div>
  ...
  <section id="projects" class="section">
    <div class="container">
      <h2 class="section-title">Kegiatan & Hasil Pelatihan Packing</h2>
      <p class="section-subtitle">
        Dokumentasi kegiatan pelatihan dan hasil praktik pengemasan oleh peserta LPK kami.
      </p>
  ...
  <section class="section" style="background:#fff; padding:60px 20px;">
    <div class="container" style="max-width:600px; margin:auto;">
      ...
      <p style="text-align:center; font-size:1.1rem; color:#555; margin-bottom:30px;">
        Kami mengharapkan ulasan dari Anda tentang kualitas Pemagangan Packing
      </p>
  ...
  <!-- SLIDE: Testimoni Pemagang Packing -->
      ...
      <div style="background:#ffffff; border-radius:20px; padding:40px; box-shadow:0 10px 25px rgba(0,0,0,0.08);">
        <div style="display:flex; align-items:center; margin-bottom:1.5rem;">
          ...
          <div>
            ...
            <p style="color:#666; margin:0; font-size:0.9rem;">Magang di PT XYZ Packaging</p>
          </div>
        </div>
        <p style="font-size:1.1rem; color:#444; font-style:italic;">
          "Selama magang, saya belajar proses pengemasan produk mulai dari pengecekan barang, penyusunan, hingga pelabelan sebelum pengiriman."
        </p>
      ...
      <div style="background:#ffffff; border-radius:20px; padding:40px; box-shadow:0 10px 25px rgba(0,0,0,0.08);">
        <div style="display:flex; align-items:center; margin-bottom:1.5rem;">
          ...
          <div>
            ...
            <p style="color:#666; margin:0; font-size:0.9rem;">Magang di PT ABC Logistic & Packing</p>
          </div>
        </div>
        <p style="font-size:1.1rem; color:#444; font-style:italic;">
          "Instruktur membimbing saya memahami standar pengemasan yang aman dan rapi agar produk tetap terjaga selama proses distribusi."
        </p>
        <div style="color:#ffd700; font-size:1.2rem; margin-top:1rem;">⭐⭐⭐⭐⭐</div>
      </div>
      ...
      <div style="background:#ffffff; border-radius:20px; padding:40px; box-shadow:0 10px 25px rgba(0,0,0,0.08);">
        <div style="display:flex; align-items:center; margin-bottom:1.5rem;">
          ...
          <div>
            ...
            <p style="color:#666; margin:0; font-size:0.9rem;">Magang di PT Maju Jaya Packing</p>
          </div>
        </div>
        <p style="font-size:1.1rem; color:#444; font-style:italic;">
          "Magang ini mengajarkan saya kecepatan kerja tanpa mengurangi kualitas, serta cara menyusun produk agar efisien di dalam kemasan."
        </p>
        <div style="color:#ffd700; font-size:1.2rem; margin-top:1rem;">⭐⭐⭐⭐⭐</div>
      </div>
