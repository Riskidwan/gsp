...
<head>
  ...
  <title>Molding Operator - PT Gemilang Sapta Perdana</title>
...
<body>
  ...
  <section class="section">
    <div class="container" style="display:flex; flex-wrap:wrap; gap:32px; align-items:center;">
      ...
      <div style="flex:1 1 340px; min-width:260px;">
        ...
        <ul style="font-size:1rem; color:#444; margin-top:1rem; padding-left:18px;">
          <li>Instruktur berpengalaman dari industri terkait</li>
  ...
  <section id="projects" class="section">
    <div class="container">
      <h2 class="section-title">Kegiatan & Hasil Pelatihan Molding Operator</h2>
      <p class="section-subtitle">
        Dokumentasi kegiatan pelatihan dan hasil praktik pengoperasian mesin injection molding oleh peserta LPK kami.
      </p>
      <div class="services-grid">
        ...
        <div class="service-card">
          ...
          <h3>Setting Mesin Injection Molding</h3>
          <p>Peserta mempelajari cara mengatur parameter mesin sesuai spesifikasi produk.</p>
        </div>
        ...
        <div class="service-card">
          ...
          <p>Latihan memasang dan melepas mold dengan prosedur aman dan efisien.</p>
        </div>
        ...
        <div class="service-card">
          ...
          <p>Pemeriksaan hasil cetakan agar sesuai standar mutu dan dimensi.</p>
        </div>
        ...
        <div class="service-card">
          ...
          <p>Perawatan mold untuk menjaga umur pakai dan kualitas hasil produksi.</p>
        </div>
        ...
        <div class="service-card">
          ...
          <p>Peserta bekerja dalam tim untuk menyelesaikan target produksi secara efisien.</p>
        </div>
  ...
  <section class="section" style="background:#fff; padding:60px 20px;">
    <div class="container" style="max-width:600px; margin:auto;">
      ...
      <p style="text-align:center; font-size:1.1rem; color:#555; margin-bottom:30px;">
        Kami mengharapkan ulasan dari Anda tentang kualitas Pemagangan Molding Operator
      </p>
