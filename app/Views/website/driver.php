...
<body>
  ...
  <section class="hero" style="background: #02a85a; color: #fff; min-height: 100vh; display: flex; align-items: center; padding: 0;">
    <div style="max-width:1200px; margin:auto; display:flex; flex-wrap:wrap; align-items:center; gap:32px; padding:56px 24px;">
      <div style="flex:1 1 420px; min-width:280px; z-index:2;">
        ...
        <p style="font-size:1.35rem; color:#90caf9; margin-bottom:1.2rem;">Pelatihan Driver Profesional & Bersertifikat</p>
  ...
  <section class="section" style="background:#f3f8ff;">
    <div class="container" style="display:flex; flex-wrap:wrap; gap:32px; align-items:center;">
      <div style="flex:1 1 340px; min-width:260px;">
        <h2 style="color:#1565c0;">Tentang Layanan Driver Training</h2>
        <p style="font-size:1.08rem; color:#444;">
          PT Gemilang Sapta Perdana memberikan solusi pelatihan driver profesional untuk perusahaan, instansi, dan perorangan. Didukung instruktur berpengalaman dan fasilitas training yang memadai sesuai standar keselamatan berkendara.
        </p>
  ...
  <section id="projects" class="section">
    <div class="container">
      <h2 class="section-title">Program Pelatihan yang Sudah Dilaksanakan</h2>
      <p class="section-subtitle">Berikut adalah dokumentasi dari beberapa program Driver Training yang telah kami laksanakan bersama mitra kami.</p>
  ...
  <section class="section" style="background:#fff; padding:60px 20px;">
    <div class="container" style="max-width:600px; margin:auto;">
      ...
      <form action="https://script.google.com/macros/s/AKfycbwJrh-8PkI90ta7PoKs_TyTQxa3jvAZCQrVjS8FHC88NVzz-2nYyw1dvRAWNIAX3aByxw/exec" method="POST" style="background:#f9fff9; padding:30px; border-radius:20px; box-shadow:0 10px 25px rgba(0,0,0,0.06);">
        ...
        <div class="form-group" style="margin-bottom:20px;">
          <label for="pesan" style="display:block; font-weight:500; margin-bottom:8px;">Umpan Balik Anda *</label>
      ...
      <div style="display:grid; grid-template-columns:repeat(auto-fit, minmax(350px, 1fr)); gap:40px;">
        <div style="background:#f8faff; border-radius:20px; padding:40px; box-shadow:0 10px 25px rgba(0,0,0,0.08);">
          <div style="display:flex; align-items:center; margin-bottom:1.5rem;">
            ...
            <div>
              <h4 style="color:#1565c0; margin:0;">Bambang Sutrisno</h4>
              <p style="color:#666; margin:0; font-size:0.9rem;">Fleet Manager PT Logistik Prima</p>
            </div>
          </div>
          <p style="font-size:1.1rem; color:#444; font-style:italic;">"Pelatihan dari GSP sangat membantu meningkatkan keselamatan dan profesionalisme driver kami. Highly recommended!"</p>
        ...
        <div style="background:#f8faff; border-radius:20px; padding:40px; box-shadow:0 10px 25px rgba(0,0,0,0.08);">
          <div style="display:flex; align-items:center; margin-bottom:1.5rem;">
            ...
            <div>
              ...
              <p style="color:#666; margin:0; font-size:0.9rem;">HR Manager Bank Sentral</p>
            </div>
          </div>
          <p style="font-size:1.1rem; color:#444; font-style:italic;">"Instruktur yang kompeten dan fasilitas training yang memadai. Driver korporat kami jadi lebih aman dan terampil."</p>
          <div style="color:#ffd700; font-size:1.2rem; margin-top:1rem;">⭐⭐⭐⭐⭐</div>
        </div>
        ...
        <div style="background:#f8faff; border-radius:20px; padding:40px; box-shadow:0 10px 25px rgba(0,0,0,0.08);">
          <div style="display:flex; align-items:center; margin-bottom:1.5rem;">
            <img src="https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=80&h=80&fit=crop&crop=face" style="width:60px; height:60px; border-radius:50%; margin-right:15px;">
            <div>
              <h4 style="color:#1565c0; margin:0;">Agus Purnomo</h4>
              <p style="color:#666; margin:0; font-size:0.9rem;">Operations Director TransJakarta</p>
            </div>
          </div>
          <p style="font-size:1.1rem; color:#444; font-style:italic;">"Program defensive driving untuk driver bus kami sangat efektif. Tingkat kecelakaan berkurang signifikan!"</p>
          <div style="color:#ffd700; font-size:1.2rem; margin-top:1rem;">⭐⭐⭐⭐⭐</div>
        </div>
      </div>
    </div>
