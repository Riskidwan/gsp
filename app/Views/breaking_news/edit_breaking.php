    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?= base_url('breaking_news/update/' . $breakingNews['id']) ?>" method="post">
                        <?= csrf_field() ?>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control <?= $validation->hasError('judul') ? 'is-invalid' : '' ?>"
                                ...
                                placeholder="Masukkan judul breaking news (minimal 10 karakter)"><?= old('judul', $breakingNews['judul']) ?></textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input type="url"
                                ...
                                id="link" name="link" value="<?= old('link', $breakingNews['link']) ?>"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number"
                                        ...
                                        id="urutan" name="urutan" value="<?= old('urutan', $breakingNews['urutan']) ?>"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="custom-control custom-switch">
                                        <input type="checkbox" class="custom-control-input" id="aktif" name="aktif" value="1"
                                            <?= old('aktif', $breakingNews['aktif']) ? 'checked' : '' ?>>
                                        <label class="custom-control-label" for="aktif">
                                            <span class="switch-text"><?= $breakingNews['aktif'] ? 'Breaking news akan ditampilkan' : 'Breaking news tidak akan ditampilkan' ?></span>
                                        </label>
                                    </div>
                                    <small class="form-text text-muted">
                        ...
                        <div class="form-group mb-0">
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save"></i> Update Breaking News
                            </button>
